    ...
    partial struct Variant_struct_nullable_enable : global::System.IEquatable<Variant_struct_nullable_enable>
    {
        ...
        private readonly struct _VariantStorage
        {
            ...
            public string TypeString
            {
                get
                {
                    switch (_n)
                    {
                        ...
                        default: throw new global::System.InvalidOperationException("Variant_struct_nullable_enable is in a corrupted state.");
                    }
                }
            }
            ...
            public void Match(global::System.Action<long> l, global::System.Action<double> d, global::System.Action<object> o)
            {
                switch (_n)
                {
                    case 0: throw new global::System.InvalidOperationException("Variant_struct_nullable_enable is empty.");
                    case 1: l(_x._1.Value); break;
                    case 2: d(_x._2.Value); break;
                    case 3: o(_x._3.Value); break;
                    default: throw new global::System.InvalidOperationException("Variant_struct_nullable_enable is in a corrupted state.");
        ...
        public Variant_struct_nullable_enable(long l) => _variant = new _VariantStorage(l);
        /// <summary>
        ...
        public Variant_struct_nullable_enable(double d) => _variant = new _VariantStorage(d);
        /// <summary>
        ...
        public Variant_struct_nullable_enable(object o) => _variant = new _VariantStorage(o);

        /// <summary>
        /// Create a Variant_struct_nullable_enable with a value of type <see cref="long"/>.
        /// </summary>
        /// <param name="l">The value to initlaize the variant with.</param>
        public static implicit operator Variant_struct_nullable_enable(long l) => new Variant_struct_nullable_enable(l);
        /// <summary>
        /// Create a Variant_struct_nullable_enable with a value of type <see cref="double"/>.
        /// </summary>
        /// <param name="d">The value to initlaize the variant with.</param>
        public static implicit operator Variant_struct_nullable_enable(double d) => new Variant_struct_nullable_enable(d);

        /// <summary>
        /// Create a Variant_struct_nullable_enable with a value of type <see cref="long"/>.
        /// </summary>
        /// <param name="l">The value to initlaize the variant with.</param>
        public static Variant_struct_nullable_enable Create(long l) => new Variant_struct_nullable_enable(l);
        /// <summary>
        /// Create a Variant_struct_nullable_enable with a value of type <see cref="double"/>.
        /// </summary>
        /// <param name="d">The value to initlaize the variant with.</param>
        public static Variant_struct_nullable_enable Create(double d) => new Variant_struct_nullable_enable(d);
        /// <summary>
        /// Create a Variant_struct_nullable_enable with a value of type <see cref="object"/>.
        /// </summary>
        /// <param name="o">The value to initlaize the variant with.</param>
        public static Variant_struct_nullable_enable Create(object o) => new Variant_struct_nullable_enable(o);
        ...
        public readonly override bool Equals(object? other) => other is Variant_struct_nullable_enable v && Equals(v);
